...
export default function OutdoorPanel() {
    ...
    const outfieldSensors = state.sensors.filter(s => s.id.startsWith('A') || s.id.startsWith('C'))
        ...
        <div style={{ padding: '24px 0', maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ marginBottom: '32px' }}>
                ...
                <p style={{ margin: '8px 0 0 0', fontSize: '14px', color: '#8aab90' }}>
                    Volumetric water calculations and solenoid valves for Maize plots (A1, A2) and Sorghum plots (C1, C2).
                </p>
            </div>
                ...
                {outfieldSensors.map(sensor => {
                    ...
                    return (
                        <div key={sensor.id} style={{
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
                                <div>
                                    ...
                                    <div style={{ fontSize: '12px', color: '#8aab90', marginTop: '4px' }}>
                                        Crop: <span style={{ color: '#d0c9b8', fontWeight: 500 }}>{sensor.crop}</span> · Depth: {sensor.depth} · Area: {sensor.area}
                                    </div>
                                </div>
                            ...
                            {/* Moisture gauge and sensor specs */}
